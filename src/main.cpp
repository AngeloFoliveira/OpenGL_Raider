...
int main(int argc, char *argv[])
{
    ...
    LoadTextureImage("../../data/chaocerto2.jpg"); // TextureImage8
...
#define ALTURAMURO 20
        ...
        for (int i = 0; i < 21; i++)
        {
            if (i == 0)
            {
                model = Matrix_Translate(55.0f, -1.0f, 20.0f) * Matrix_Scale(15.0f, ALTURAMURO, 50.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
            ...
            {
                model = Matrix_Translate(45.0f, -1.0f, 60.0f) * Matrix_Scale(10.0f,ALTURAMURO, 10.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(30.0f, -1.0f, 40.0f) * Matrix_Scale(15.0f, ALTURAMURO, 30.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(30.0f, -1.0f, 20.0f) * Matrix_Scale(30.0f, ALTURAMURO, 10.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(0.0f, -1.0f, 40.0f) * Matrix_Scale(20.0f, ALTURAMURO, 30.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-10.0f, -1.0f, 60.0f) * Matrix_Scale(10.0f, ALTURAMURO, 10.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-30.0f, -1.0f, 40.0f) * Matrix_Scale(20.0f, ALTURAMURO, 30.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-60.0f, -1.0f, 30.0f) * Matrix_Scale(20.0f, ALTURAMURO, 40.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-80.0f, -1.0f, 30.0f) * Matrix_Scale(20.0f,ALTURAMURO,15.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-30.0f, -1.0f, 20.0f) * Matrix_Scale(50.0f,ALTURAMURO,10.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(0.0f, -1.0f, -80.0f) * Matrix_Scale(20.0f,ALTURAMURO,50.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(0.0f, -1.0f, -20.0f) * Matrix_Scale(20.0f,ALTURAMURO,40.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-30.0f, -1.0f, -65.0f) * Matrix_Scale(30.0f,ALTURAMURO,20.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-30.0f, -1.0f, -45.0f) * Matrix_Scale(20.0f,ALTURAMURO,55.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(30.0f, -1.0f, -80.0f) * Matrix_Scale(15.0f,ALTURAMURO,15.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(30.0f, -1.0f, -65.0f) * Matrix_Scale(40.0f,ALTURAMURO,15.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(60.0f, -1.0f, -50.0f) * Matrix_Scale(10.0f,ALTURAMURO,60.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(30.0f, -1.0f, -40.0f)*Matrix_Scale(20.0f,ALTURAMURO,50.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-80.0f, -1.0f, -20.0f) * Matrix_Scale(40.0f,ALTURAMURO,20.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-70.0f, -1.0f, 0.0f) * Matrix_Scale(10.0f, ALTURAMURO, 20.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
            ...
            {
                model = Matrix_Translate(-50.0f, -1.0f, 0.0f) * Matrix_Scale(10.0f,ALTURAMURO, 20.0f);
                glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
                glUniform1i(g_object_id_uniform, MURO);
                DrawVirtualObject("the_cube");
            }
        ...
        model = Matrix_Translate(+xl, 2.0f, zl) * Matrix_Scale(ESCALALARAVELHA, ESCALALARAVELHA, ESCALALARAVELHA)*Matrix_Rotate_Y(camera_view_vector[2]*0.15);
        glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
